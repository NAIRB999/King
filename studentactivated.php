 ...
 if (isset($_POST['btnupdate']))
   ...
   //  $txtpassword=$_POST['txtpassword'];
    ...
    $update="UPDATE tblstudent
      ...
      if($run)
      {
        echo "<script>alert('Student Activation Successful')</script>";
        echo "<script>location='studentlist.php'</script>";
						...
						<form method="post" action="#">
									...
									<div class="row uniform">
										<div class="6u 12u$(xsmall)">
											Name: <input type="text" name="txtname" id="name" value="<?php echo $name ?>" />
										</div>
										...
										<div class="12u$">
												Address: <input type="text" name="txtaddress" id="phone" value="<?php echo $address ?>" />
										</div>
										...
										<div class="12u$">
											<ul class="actions">
												<li><input type="submit" name="btnupdate" value="Activate" /></li>
