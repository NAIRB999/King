...
if (isset($_POST['btnlogin'])) 
{
    ...
    if($count==0)
    {
        ...
        {
            echo '<script type="text/javascript">alert("Username and Password incorrect OR Your account is not activated yet!");
    ...
    else
    {
        ...
        echo '<script type="text/javascript">alert("Success");
                   window.location.href="documenttitlelist.php";</script>';
    }
                                ...
                                <div class="row uniform 50%">
                                    ...
                                    <div class="12u$">
                                        <ul class="actions">
                                            ...
                                            If you don't have an account, Click <a href="studententry.php">Here</a>
                                        </ul>
                                    </div>
                                </div>
                            </form>
