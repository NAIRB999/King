			...
			<section id="main" class="wrapper">
				<div class="inner">
					...
					<div class="image fit">
						...
						<!-- Form -->
						<br>
						<h3>Percentage of Contributions for each academic year</h3>

						<form method="post" action="#" enctype="multipart/form-data">
									
						         <?php  
						          $adminquery="SELECT * FROM qrypercentage_of_contributions p, tbldocumenttitle d, tblacademicyear a
						          				WHERE d.academicyearid=a.academicyearid
						          				AND a.academicyear=p.academicyear";
						              ...
						              <table align='center' class="table-wrapper">
						                      <thead>
						                          <tr>
						                              <th> Academic year </th>
						                              <th> Title </th>
						                              <th> Percentage_of_Contribution</th>
						                          </tr>
						                      </thead>
						              <tbody>
						               <?php  
