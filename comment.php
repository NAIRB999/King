					...
					<div class="image fit">
						...
						<form method="post" action="#">
									...
									<div class="row uniform">
										...
										<div class="6u 12u$(xsmall)">
											File Name: <input type="text" name="txtfilename" id="name" value="<?php echo $filename ?>" readonly/>
										</div>

										<div class="6u 12u$(xsmall)">
											Documenttype: <input type="text" name="txtdocumenttype" id="name" value="<?php echo $documenttype ?>" readonly />
										</div>

										<div class="12u$">
											Comment: <textarea name="txtcomment"  id="textarea" required=""></textarea> 
										</div>

										<div class="12u$">
											<ul class="actions">
												<li><input type="submit" name="btnsubmit" value="Comment" /></li>
